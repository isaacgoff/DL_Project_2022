...
from create_dataset_fast import create_dataset_fast
...
def main():
    ...
    start = datetime.now()
    # Create datasets
    tng_dataset = create_dataset_fast(audio_input_path_tng, json_path_tng, args.num_mels, args.num_fft, args.hop_len)
    val_dataset = create_dataset_fast(audio_input_path_val, json_path_val, args.num_mels, args.num_fft, args.hop_len)
